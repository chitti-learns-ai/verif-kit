/* eslint-disable */
// @ts-nocheck
// Extracted from blakeembrey/pluralize (MIT). UMD wrapper replaced with an IIFE +
// ES module export. Internal logic UNCHANGED.
...
export function isSingular(word) { return pluralize.isSingular(word); }
